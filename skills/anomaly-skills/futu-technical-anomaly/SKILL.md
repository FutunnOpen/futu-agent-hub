...
This skill depends on Futu **OpenD** (default `127.0.0.1:11111`) to fetch technical anomaly data. **Before** running the Workflow below, you must confirm OpenD is running, otherwise `scripts/handle_technical_anomaly.py` will fail because it cannot connect to OpenD.
