...
```bash
futu-skills check --quiet 2>/dev/null | grep '^futu-capital-anomaly' > /tmp/.futu-capital-anomaly-update 2>/dev/null & curl -sG '...' ...; wait; cat /tmp/.futu-capital-anomaly-update 2>/dev/null; rm -f /tmp/.futu-capital-anomaly-update
```
