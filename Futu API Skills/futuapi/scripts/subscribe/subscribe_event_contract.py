...
功能：指定合约代码和订阅的数据类型即可订阅事件合约实时信息（盘口/逐笔/K线等）
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="订阅事件合约实时信息")
